    ...
    <>
      ...
      <div className="min-h-screen prose flex flex-col m-auto">
        <div className="mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:px-8">
          ...
          <p className="mb-4">
            Thank you for visiting Expense Sorted. Your privacy is important to us,
            and we want you to feel comfortable using our website. This Privacy
            Policy will inform you about what information we collect, how we use
            it, and what choices you have regarding the use of your personal
            information.
          </p>
          <h2 className="mb-4 text-xl font-bold">Information We Collect</h2>
          <p className="mb-4">
            When you use Expense Sorted, we may collect certain information about
            you, including:
          </p>
          ...
          <p className="mb-4">
            ...
            on our website. We may also use your information for other purposes
          ...
          <p className="mb-4">
            When you use our service with your Google account, we handle your
            data with utmost care and transparency:
          </p>
          <ul className="mb-4 ml-6 list-disc">
            <li>
              We only store the minimum necessary Google user data required to
              provide our services
            </li>
            <li>
              Your Google user data is retained only for as long as necessary to
              provide our services or until you request deletion
            </li>
            <li>
              You can request deletion of your Google user data at any time by
              contacting us at{" "}
              <a href="mailto:f.strauf@gmail.com">f.strauf@gmail.com</a>
            </li>
            <li>
              Upon receiving a deletion request, we will remove all your Google
              user data from our systems within 30 days
            </li>
            <li>
              If you revoke our application's access through your Google Account
              settings, we will automatically delete all associated Google user
              data within 30 days
            </li>
          </ul>
          ...
          <p className="mb-4">
            ...
            <a href="mailto:f.strauf@gmail.com">here</a>.
          </p>
        </div>
      </div>
      {/* </Layout> */}
