...
export default function PageHeader({ title, subtitle, className = "" }: PageHeaderProps) {
  return (
    <div className={`text-center ${className}`}>
      <h1 className="text-4xl md:text-6xl font-bold mb-8 bg-clip-text text-transparent bg-linear-to-r from-primary-dark via-primary to-secondary animate-gradient pb-2 leading-normal">
        {title}
      </h1>
